...
public class Init {
	...
	public static void AddRecipes(){
			...
			if (ConfigHandler.woodDoor){
				GameRegistry.addShapelessRecipe(new ItemStack(Blocks.planks, 6), new ItemStack(Items.wooden_door, 1));
			}
			...
			if (ConfigHandler.fences) {
				GameRegistry.addShapedRecipe(new ItemStack(Blocks.nether_brick, 6), "   ", "XXX", "XXX", 'X', new ItemStack(Blocks.nether_brick_fence));
				GameRegistry.addShapedRecipe(new ItemStack(Blocks.planks, 3, 0), "   ", "   ", "XXX", 'X', new ItemStack(Blocks.fence));
			}
